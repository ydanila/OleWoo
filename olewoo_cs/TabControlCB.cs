...
namespace olewoo_cs
{
    public partial class TabControlCB : TabControl
    {
        ...
        protected override void OnDrawItem(DrawItemEventArgs e)
        {
            if (e.Bounds != RectangleF.Empty)
            {
                ...
                for (int nIndex = 0; nIndex < this.TabCount; nIndex++)
                {
                    ...
                    {
                        Rectangle icon = new Rectangle((int)tabTextArea.X, (int)tabTextArea.Y, (int)tabTextArea.Width, (int)tabTextArea.Height);
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
                ...
                {
                    IClearUp icu = this.SelectedTab.Tag as IClearUp; // IDispose not appropriate.
